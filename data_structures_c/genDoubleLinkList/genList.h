 ...
 * @params _list: A pointer to previously created List returned via ListCreate
 * @params _item: the element to add
 * @returns error code
 ...
 *  @details if successfully, stores a pointer to the removed item in _item
 *           time complexity O(1).
 * @params _list: A pointer to previously created List returned via ListCreate
 * @params _pItem:  To store a pointer to the removed item in _item
 * @returns error code
 * @retval LIST_SUCCESS on success
 ...
 * @params _list : A pointer to previously created List returned via ListCreate
 * @returns nItems: number of elements
 */
